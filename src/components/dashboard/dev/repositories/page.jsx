...
export default function RepositoriesPageComponent() {
  const repos = [
    ...
    <div>
      ...
      <div className="grid gap-4">
        {repos.map((repo) => (
          <div
            key={repo.id}
            className="bg-slate-900 border border-slate-800 rounded-xl flex p-3 items-center justify-between hover:border-cyan-500/50 transition-all"
          >
