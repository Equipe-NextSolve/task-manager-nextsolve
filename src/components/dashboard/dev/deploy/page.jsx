...
export default function DeployPageComponent() {
  const servers = [
    {
      name: "Production",
      status: "Online",
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500">
          Gerencie suas instâncias e monitore builds em tempo real.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {servers.map((server) => (
          ...
          >
            ...
            <button
              type="button"
              className="w-full mt-6 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-lg text-sm font-bold transition-all"
            >
              Ver Logs do Console
            </button>
          </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex items-center gap-4 text-sm border-t border-slate-800 pt-4">
            ...
            <span className="text-slate-300 font-medium">
              Otimizando assets da aplicação...
            </span>
